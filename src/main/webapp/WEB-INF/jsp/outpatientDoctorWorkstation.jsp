                                    ...
                                    <form id="prescriptionForm" role="form" onkeypress="return event.keyCode !== 13;">
                                        ...
                                        <div id="prescriptionCard" class="card">
                                            ...
                                            <table class="table table-condensed table-striped table-hover table-sm table-bordered" >
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input" id="'+listName+diseaseId+'Radio2" value="-1">
                                                            <label class="custom-control-label" for="'+listName+diseaseId+'Radio2"></label>
                                                        </div>
                                                    </td>
                                                    <td>2</td>
                                                    <td style="padding: 0">
                                        ...
                                        <div id="drugsCard" class="card">
                                            ...
                                            <table class="table table-condensed table-striped table-hover table-sm table-bordered" >
                                                ...
                                                <tr>
                                                    <td rowspan="2">200</td>
                                                    <td rowspan="2">胃镜烦烦烦烦烦烦</td>
                                                    <td rowspan="2">0.500g*12片/盒</td>
                                                    <td rowspan="2">200.00</td>
                                                    <td><!--用法 1口服 2静脉注射 3肌肉注射 4皮试 5皮下注射 6静脉滴注 7外用 8喷雾吸入 9其他-->
                                                        <select name="usage" class="custom-select-sm">
                                                            <option value="0" selected></option>
                                                            <option value="1">口服</option>
                                                            <option value="2">静脉注射</option>
                                                            <option value="3">肌肉注射</option>
                                                            <option value="4">皮试</option>
                                                            <option value="5">皮下注射</option>
                                                            <option value="6">静脉滴注</option>
                                                            <option value="7">外用</option>
                                                            <option value="8">喷雾吸入</option>
                                                            <option value="9">其他</option>
                                                        </select>
                                                    </td>
                                                    <td style="padding: 0;width: 60px"><input class="form-control " name="consumption" type="text"></td>
                                                    <td>
                                                        <select name="frequent" class="custom-select-sm"><!--频次,1一天一次 ，2一天两次 3一天三次 4其他-->
                                                            <option value="0" selected></option>
                                                            <option value="1">一天一次</option>
                                                            <option value="2">一天两次</option>
                                                            <option value="3">一天三次</option>
                                                            <option value="4">其他</option>
                                                        </select>
                                                    </td>
                                                    <td style="padding: 0"><input class="form-control " name="days" type="number"> </td>
                                                    <td style="padding: 0"><input class="form-control " name="amount" type="number"> </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4" style="padding: 0">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="entrustment">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <p>保存</p>
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <form id="prescriptionContextForm" role="form" onkeypress="return event.keyCode !== 13;">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <label class="font-weight-bold">创建时间：</label ><span id="prescriptionCreatTime">2018-01-01 02:02</span>
                                                                    </div>
                                                                    <!--组套子项-->
                                                                    <div class="form-group">
                                                                        <input type="hidden" name="fmeitemId" value="-1"><input type="hidden" name="setSubEntrust" value=" ">
